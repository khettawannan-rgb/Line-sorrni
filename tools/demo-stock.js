...
import stockMock from '../project-root/src/services/stock/mocks/stock.json' with { type: 'json' };

const scenario = process.argv[2];
let stockData = stockMock;
if (scenario) {
  const module = await import(`../project-root/src/services/stock/mocks/${scenario}.json`, { with: { type: 'json' } }).catch(() => null);
